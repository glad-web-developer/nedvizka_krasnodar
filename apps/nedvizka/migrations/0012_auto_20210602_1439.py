# Generated by Django 3.0.13 on 2021-06-02 05:39
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('nedvizka', '0011_auto_20210602_1353'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nedvizka', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='video_set', to='nedvizka.KvartiraVtorichkaProdaza', verbose_name='Недвижка')),
            ],
            options={
                'verbose_name': 'Видео',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('video', models.TextField(help_text='Будет выводиться только если выбран шаблонное оформление страницы объекта', verbose_name='Iframe код видео')),
                ('index_sortirivki', models.IntegerField(default=0, help_text='Чем больше тем раньше выведет', verbose_name='Индекс сортировки')),
                ('nedvizka', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='video_set', to='nedvizka.KvartiraVtorichkaArenda', verbose_name='Недвижка')),
            ],
            options={
                'verbose_name': 'Видео',
                'verbose_name_plural': 'Видео',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('index_sortirivki', models.IntegerField(default=0, help_text='Чем больше тем раньше выведет', verbose_name='Индекс сортировки')),
                ('nedvizka', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='panorami_set', to='nedvizka.KvartiraVtorichkaProdaza', verbose_name='Недвижка')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('iframe_code', models.TextField(help_text='Будет выводиться только если выбран шаблонное оформление страницы объекта', verbose_name='iframe код')),
                ('index_sortirivki', models.IntegerField(default=0, help_text='Чем больше тем раньше выведет', verbose_name='Индекс сортировки')),
                ('nedvizka', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='panorami_set', to='nedvizka.KvartiraVtorichkaArenda', verbose_name='Недвижка')),
            ],
            options={
                'verbose_name': 'Панорамы',
                'verbose_name_plural': 'Панорамы',
        ...
        migrations.CreateModel(
            name='FotoKvartiraVtorichkaProdaza',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('index_sortirivki', models.IntegerField(default=0, help_text='Чем больше тем раньше выведет', verbose_name='Индекс сортировки')),
                ...
                ('nedvizka', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='foto_set', to='nedvizka.KvartiraVtorichkaProdaza', verbose_name='Недвижка')),
            ],
            options={
                'verbose_name': 'Фото',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('index_sortirivki', models.IntegerField(default=0, help_text='Чем больше тем раньше выведет', verbose_name='Индекс сортировки')),
                ('img', filer.fields.image.FilerImageField(on_delete=django.db.models.deletion.CASCADE, to=settings.FILER_IMAGE_MODEL, verbose_name='Фото')),
                ('nedvizka', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='foto_set', to='nedvizka.KvartiraVtorichkaArenda', verbose_name='Недвижка')),
            ],
            options={
                'verbose_name': 'Фото',
                'verbose_name_plural': 'Фото',
