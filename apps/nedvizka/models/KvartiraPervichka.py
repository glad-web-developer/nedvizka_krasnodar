...
class KvartiraPervichkaProdaza(models.Model):
    class Meta:
...
class FotoKvartiraPervichkaProdaza(models.Model):
    class Meta:
        verbose_name = 'Фото'
        verbose_name_plural = 'Фото'
        ordering = ['-index_sortirivki']

    nedvizka = models.ForeignKey(KvartiraPervichkaProdaza, verbose_name='Недвижка', on_delete=models.CASCADE, null=True, blank=True,
...
class VideoKvartiraPervichkaProdaza(models.Model):
    class Meta:
        verbose_name = 'Видео'
...
class PanoramiKvartiraPervichkaProdaza(models.Model):
    class Meta:
...
class KvartiraPervichkaArenda(models.Model):
    class Meta:
...
class FotoKvartiraPervichkaArenda(models.Model):
    class Meta:
        verbose_name = 'Фото'
        verbose_name_plural = 'Фото'
        ordering = ['-index_sortirivki']

    nedvizka = models.ForeignKey(KvartiraPervichkaArenda, verbose_name='Недвижка', on_delete=models.CASCADE, null=True, blank=True,
                            related_name='foto_set')
    img = FilerImageField(verbose_name='Фото', on_delete=models.CASCADE)
    index_sortirivki = models.IntegerField('Индекс сортировки', default=0, help_text='Чем больше тем раньше выведет')
...
class VideoKvartiraPervichkaArenda(models.Model):
    class Meta:
        verbose_name = 'Видео'
        verbose_name_plural = 'Видео'
        ordering = ['-index_sortirivki']
...
class PanoramiKvartiraPervichkaArenda(models.Model):
    class Meta:
        verbose_name = 'Панорамы'
        verbose_name_plural = 'Панорамы'
        ordering = ['-index_sortirivki']
