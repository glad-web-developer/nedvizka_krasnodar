...
class KomerchiskieProdaza(models.Model):
    class Meta:
...
class VideoKomerchiskieProdaza(models.Model):
    class Meta:
        verbose_name = 'Видео'
...
class PanoramiKomerchiskieProdaza(models.Model):
    class Meta:
...
class KomerchiskieArenda(models.Model):
    class Meta:
        verbose_name = 'Комерчиские - аренда'
        verbose_name_plural = 'Комерчиские - аренда'
...
class FotoKomerchiskieArenda(models.Model):
    class Meta:
        verbose_name = 'Фото'
        verbose_name_plural = 'Фото'
        ordering = ['-index_sortirivki']

    nedvizka = models.ForeignKey(KomerchiskieArenda, verbose_name='Недвижка', on_delete=models.CASCADE, null=True, blank=True,
                            related_name='foto_set')
    img = FilerImageField(verbose_name='Фото', on_delete=models.CASCADE)
    index_sortirivki = models.IntegerField('Индекс сортировки', default=0, help_text='Чем больше тем раньше выведет')
...
class VideoKomerchiskieArenda(models.Model):
    class Meta:
        verbose_name = 'Видео'
        verbose_name_plural = 'Видео'
        ordering = ['-index_sortirivki']
...
class PanoramiKomerchiskieArenda(models.Model):
    class Meta:
        verbose_name = 'Панорамы'
        verbose_name_plural = 'Панорамы'
        ordering = ['-index_sortirivki']
